...
public class UserDAOTest {
  ...
  public void setUp() throws DataAccessException {
    ...
    bestUser = new User("HotRodRed", "Ironman", "Jarvis", "TonyStark@Stark.com",
            "Tony", "Stark", "M");
  ...
  public void insertPass() throws DataAccessException {
    ...
    uDAO.UserDao_insert(bestUser);
    // Let's use a find method to get the event that we just put in back out.
    User compareTest = uDAO.UserDao_find(bestUser.getUsername());
  ...
  public void insertFail() throws DataAccessException {
    ...
    assertThrows(DataAccessException.class, () -> uDAO.UserDao_insert(bestUser));
  }
  ...
  {
    uDAO.UserDao_insert(bestUser);
    assertNull( uDAO.UserDao_find("WrongID"));
  }

  @Test
  public void throwNULLPass() throws DataAccessException
  {
    bestUser = new User("HotRodRed", "Ironman", "Jarvis", null,
            null, null, "M");
    assertThrows(DataAccessException.class, () -> uDAO.UserDao_insert(bestUser));
  }
  ...
  public void clearPass() throws DataAccessException
  {
    uDAO.UserDao_insert(bestUser);
    uDAO.UserDao_clear();
    assertNull(uDAO.UserDao_find(bestUser.getPersonID()));
  }
}
